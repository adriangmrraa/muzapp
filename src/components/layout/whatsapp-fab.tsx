...
function FABInner() {
  ...
  const refCode = buildRefCode({
    campaign: utms.campaign ?? "organic",
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-xl transition-transform hover:scale-110 whatsapp-pulse"
