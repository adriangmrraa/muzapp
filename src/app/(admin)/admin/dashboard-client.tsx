...
import type { DashboardCard, ActivityItem } from "./page";
...
function StatsCard({ card }: { card: DashboardCard }) {
...
export function DashboardClient({ cards, activity }: DashboardClientProps) {
  return (
